...
BOARD_KERNEL_CMDLINE := console=ttyHSL0,115200,n8 androidboot.console=ttyHSL0 user_debug=31 msm_rtb.filter=0x37 androidboot.hardware=f70n androidboot.selinux=enforcing
...
BOARD_HARDWARE_CLASS := device/lge/f70n/cmhw/
...
TARGET_RECOVERY_FSTAB := device/lge/f70n/rootdir/fstab.f70n
